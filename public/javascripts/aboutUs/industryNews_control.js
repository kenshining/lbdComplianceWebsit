...
var getList=function(page){  
    $.lbdAjax({
        url :'/aboutUs/industryNewsByPage',
        type:'GET',
        dataType:'JSON',
        data:{ 
           page:page,
...
var Rander=function(data){ 
	...
	if(data.content.length>0){
		for(var i=0;i<data.content.length;i++){
            ...
            html+='<a onclick="changeCurrentMenu(\'/aboutUs/newsInfo?id='+id+'&type=consultation\',\'menuIndustryNews\');" href="javascript:void(0);">'+title+'</a>';
