...
var Rander=function(data){ 
	...
	if(data.content.length>0){
		for(var i=0;i<data.content.length;i++){
			...
			var preview=content[i].preview.replace(/&nbsp;/g,'');  
			...
			html+='<p class="newsTitle"><a onclick="changeCurrentMenu(\'/aboutUs/newsInfo?id='+id+'&type=companyDynamic\',\'menuCompanyNews\');" href="javascript:void(0);">'+title+'</a></p>';
