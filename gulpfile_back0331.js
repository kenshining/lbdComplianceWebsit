...
　　});
    ...
    gulp.task('watch',function(){
         gulp.watch('public/stylesheets/**/*.css',['cssmin','revHtml']);
         gulp.watch('public/javascripts/**/*.js',['jshint','minifyjs','revHtml']);
         gulp.watch('public/images/**/*.{png,jpg,gif}',['imagesmin','revCss']);
